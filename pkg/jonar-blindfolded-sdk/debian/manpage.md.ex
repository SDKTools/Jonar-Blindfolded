% jonar-blindfolded-sdk(SECTION) | User Commands
%
% "November  6 2025"
...
jonar-blindfolded-sdk - program to do something

# SYNOPSIS

**jonar-blindfolded-sdk** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**jonar-blindfolded-sdk** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **jonar-blindfolded-sdk** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**jonar-blindfolded-sdk** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    jonar-blindfolded-sdk. See **foo.conf**(5) for further details.
...
**jonar-blindfolded-sdk** provides some return codes, that can be used in scripts:
...
Paiva <loc.dev.loss.of.control@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Paiva

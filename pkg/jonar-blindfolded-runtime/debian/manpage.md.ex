% jonar-blindfolded-runtime(SECTION) | User Commands
%
% "June 28 2026"
...
jonar-blindfolded-runtime - program to do something

# SYNOPSIS

**jonar-blindfolded-runtime** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**jonar-blindfolded-runtime** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **jonar-blindfolded-runtime** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**jonar-blindfolded-runtime** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    jonar-blindfolded-runtime. See **foo.conf**(5) for further details.
...
**jonar-blindfolded-runtime** provides some return codes, that can be used in scripts:
